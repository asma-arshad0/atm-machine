...
// Fast Cash
    if (operationAns.operation === "Fast Cash") { let amountFast= await inquirer.prompt
        (
        { 
            name: "amount",
            type: "list",
    ...
    // Fast cash along with the condition of insufficient balance is less than my balance
    if (amountFast > myBalance){console.log("Insufficent Balance");}
    else{
...
// Cash Withdrawal
     else if (operationAns.operation === "Cash Withdrawal") { let amountAns= await inquirer.prompt(
        { 
          name: "amount",
          type: "number",
       ...
       if(amountAns.amount > myBalance){ console.log("Insfficient Balance");}
        else { 
